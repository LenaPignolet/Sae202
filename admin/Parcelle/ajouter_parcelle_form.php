            ...
            <div class="content">
                <div class="container">
                    <div class="page-title">
                        <h3>Ajouter un nouveau parcelle</h3>
                    </div>
                        ...
                        <div class="box-body">
                            <div class="tab-content" id="myTabContent">
                                <div class="tab-pane fade active show" id="general" role="tabpanel" aria-labelledby="general-tab">
                                    <div class="col-md-6">
                                        <form action="ajouter_parcelle_valid.php" method="POST" enctype="multipart/form-data">
                                            <div class="mb-3">
                                                <label class="form-label">Le nom de parcelle</label>

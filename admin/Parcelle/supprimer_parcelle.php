    ...
    <div class="wrapper">
        <nav id="sidebar" class="active">
            ...
            <ul class="list-unstyled components text-secondary">
                <li>
                    <a href="../admin.php"><i class="fas fa-home"></i> <Table>Tableau de bord</Table></a>
                </li>
                <li>
                        ...
                        <li class="nav-item dropdown">
                            <div class="nav-dropdown">
                                <div class="dropdown-menu dropdown-menu-end nav-link-menu" aria-labelledby="nav1">
                                    <!-- Ajouter des éléments de menu si nécessaire -->
                                </div>
                            </div>
                        </li>
                    </ul>
                        ...
                        <div class="box-body">
                            <div class="tab-content" id="myTabContent">
                                <div class="tab-pane fade active show" id="general" role="tabpanel" aria-labelledby="general-tab">
                                    <div class="col-md-6">
                                        <?php
                                        // Vérifier si le paramètre 'num' est défini dans l'URL
                                        if (isset($_GET['num'])) {

                                            // Récupérer l'ID de la parcelle depuis l'URL
                                            $parcelleId = $_GET['num'];
                                            ...
                                            $req = 'DELETE FROM Parcelle WHERE parcelle_id = :parcelleId';
                                            $stmt = $mabd->prepare($req);

                                            try {
                                                // Exécution de la requête avec liaison des paramètres
                                                $stmt->execute(['parcelleId' => $parcelleId]);
                                                echo '<p>Suppression de la parcelle réussie ! <i class="fas fa-circle-check" style="color: #037c58;"></i></p>';
                                                echo "<br>";
                                            ...
                                            echo '<p>Aucun ID de parcelle fourni.</p>';
                                        }
                                        ?>
                                    </div> <!-- Fin de .col-md-6 -->
                                </div> <!-- Fin de .tab-pane -->
